...
<img src="logopic.png" style="width:100px;" />
  <a class="active" href="insert.php">Dashboard</a>
...
<tr>
<th style="color:white;width:300px;height:80px; position:relative;bottom:2px;font-size:25px;"><a href="insertpbrand.php" style="color:white;">Insert Brands</a></th>
</tr>
<tr>
...
<tr>
<th style="color:white;width:300px;height:80px; position:relative;bottom:2px;font-size:25px;"><a href="Viewaccounts.php" style="color:white;">View Orders</a></th>
</tr>
<tr>
...
if(isset($_POST['save'])){
$cat=$_POST['cat'];
$query="insert into brand(brand_title) values('$cat')";

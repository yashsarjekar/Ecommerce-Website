...
<?php if(isset($_SESSION['username'])){
	...
	while($rowquery=mysqli_fetch_array($runquery)){
		$c_id=$rowquery['cat_idc'];
		$c_title=$rowquery['cat_title'];
	?>
<tr>
<td><center><?php echo $c_id;?></center></td>
<td><center><?php echo $c_title;?></center></td>
<td><center><a href="Deletecate.php?c_id=<?php echo $c_id;?>" style="color:white;">Delete</a></center></td>
</tr>	
	<?php }?>
	</table>
<?php	}else{
...
<div id="dito" style="width:300px;height:900px;background-color:#25373D;position:relative;bottom:133px;right:10px;">
<table>
<tr>
